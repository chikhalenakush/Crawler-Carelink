...
public class CrawlerCarelink {
	...
	Username = keyboard.nextLine();
	  ...
	  System.out.println("Start and end date should not be less than 01/01/1998 and should not be greater than Today's date.");
	  System.out.println("End date should not be less than Start date.");
	  
			  System.out.println("Please Enter Start Date");  
		        StartDate = keyboard.nextLine(); // String date
		        
		        System.out.println("Please Enter End Date");  
		        EndDate = keyboard.nextLine(); // String date

		      EnterBooleanValue bool = new EnterBooleanValue();
